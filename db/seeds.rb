...
require 'ffaker'
5.times do |i|
  @t = User.create(name: FFaker::Name.name, email: FFaker::Internet.unique.email, cnic: '25202-2246788-9',
                   phone_no: '0320-6666666', address: FFaker::Address.street_address, password: '123456')
  3.times do |j|
